...
public class Constants
{
    ...
    // redis中保存分类信息的键名
    public static final String REDIS_KEY_CATEGORIES_INFO = REDIS_KEY_PREFIX + "category:info";
    // redis中上传视频的键名
    public static final String REDIS_KEY_UPLOADING_VIDEO = REDIS_KEY_PREFIX + "uploading-video:";
